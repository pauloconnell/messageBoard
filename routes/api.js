...
module.exports = function(app) {
  ...
  var findBoard = async (board, done) => {
    ...
    await Thread.find({ board: board }, (err, data) => {
    ...
    .get(async (req, res) => {
      ...
      await findBoard(board, function(err, data) {
        ...
        if (data) {
          ...
          console.log(
            "should never see this because board will already be saved"
          );
          return null;
        }
      });
  ...
  app
    ...
    .post(function(req, res) {
      ...
      let isExisting;
      if (
        !isExistingThread(board, function(err, result) {
